	...
	constructor() {
		...
		this.state = {
			jobs: [
				...
				{'id': 2, 'title':null, 'project':'Neural Network','link':'https://github.com/stzuko/neural-network','img':'nn.png','desc':['Built a neural network from scratch to run with multi-depth/width settings on nonbinary features','Graphed test set classifier accuracy to portray best depth and width combinations for learning']},
				{'id': 3, 'title':null, 'project':'Classifier Comparison','link':'https://github.com/stzuko/IBK-v-J48','img':'knn.png','desc':['Demonstrated iterable kNN and decision tree learning on multi-feature classification sets','Graphed best test set accuracy as a product of variation in features vs train set size']},
				{'id': 4, 'title':null, 'project':'Universal Machine','link':'https://github.com/stzuko/universal-machine','img':'um.png','desc':['Coded a fully functional (13-command) UM with segmented memory in C as part of a paired team','Tested refactored code against progressively better benchmarks with GDB/DDB debugging']},
			]
		}
	}
